...
export const SearchBar = () => {
  return (
    <form className='mr-[53px] flex w-full items-center justify-end'>
      <div className='relative w-full max-w-[657px] rounded-[10px] bg-searchBarBg text-gray focus-within:text-white'>
        ...
        <input className='focus-active block w-full bg-transparent pt-[12px] pb-[11px] pl-11 text-[13px] leading-[18px]' />
      </div>
      <input
        className='nav-link-base ml-[33px] cursor-pointer text-[15px] font-extrabold leading-5'
        type='submit'
        value='Search'
      />
    </form>
