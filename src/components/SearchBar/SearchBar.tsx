...
export const SearchBar = ({ classes }: SearchBarProps) => {
  return (
    <form
      className={clsxm(
    ...
    >
      <div className='relative w-full max-w-[657px] rounded-[10px] bg-searchBarBg text-gray focus-within:text-white lg:mx-0 lg:mx-0 lg:flex-nowrap lg:rounded-none lg:bg-black'>
        ...
        <input className='focus-active block w-full bg-transparent pt-[12px] pb-[11px] pl-11 text-[13px] leading-[18px] lg:focus:border-transparent lg:active:border-transparent' />
      </div>
      <input
